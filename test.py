...
class OpenUtopiaFinanceApp:
    ...
    def bind_shortcuts(self):
        ...
        self.root.bind("<CTRL-S>", lambda event: self.save_graph())
        self.root.bind("<CTRL-M>", lambda event: self.enable_move())
        self.root.bind("<CTRL-Z>", lambda event: self.enable_zoom())
        self.root.bind("<CTRL-Z>", lambda event: self.go_forward())
